...
})(exports.BoostedRouteStepType || (exports.BoostedRouteStepType = {}));
/**
...
var BoostedRoute = /*#__PURE__*/function () {
  function BoostedRoute(pools, input, output) {
    ...
    if (pools.length === 0 && wrappedOutput.isBoosted && !wrappedInput.isBoosted) {
      !wrappedOutput.underlying.equals(wrappedInput) ?  invariant(false, 'DIRECT_WRAP: output must wrap input')  : void 0;
      this.pools = pools;
      this.tokenPath = [wrappedInput, wrappedOutput];
      this.steps = [{
        type: exports.BoostedRouteStepType.WRAP,
    ...
    if (pools.length === 0 && wrappedInput.isBoosted && !wrappedOutput.isBoosted) {
      !wrappedInput.underlying.equals(wrappedOutput) ?  invariant(false, 'DIRECT_UNWRAP: input must unwrap to output')  : void 0;
      this.pools = pools;
      this.tokenPath = [wrappedInput, wrappedOutput];
      this.steps = [{
        type: exports.BoostedRouteStepType.UNWRAP,
        tokenIn: wrappedInput,
        tokenOut: wrappedOutput
      }];
      this.input = input;
    ...
    // ═══════════════════════════════════════════════════════════
    !(pools.length > 0) ?  invariant(false, 'POOLS: routes with pools must have at least one pool')  : void 0;
    var chainId = pools[0].chainId;
    var allOnSameChain = pools.every(function (pool) {
      return pool.chainId === chainId;
    });
    ...
    var _loop = function _loop() {
      ...
      if (isToken0 || isToken1) {
        ...
        steps.push({
          type: exports.BoostedRouteStepType.SWAP,
...
exports.BoostedRoute = BoostedRoute;
exports.BoostedToken = BoostedToken;
